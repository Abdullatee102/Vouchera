...
import { submitWelcomeRequest, hasPendingWelcomeRequest, generateWelcomeRequestMessage, subscribeWelcomeRequests } from '../utils/welcomeRequests';
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.75rem', marginBottom: '0.75rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '1.15rem', color: '#c084fc' }}>
              Free 2 Welcome Activity Points
            </h3>
            <span className="badge badge-primary">+2 Points Fixed</span>
          </div>
          <p style={{ margin: 0, color: 'var(--color-muted)', fontSize: '0.85rem' }}>
            New participants are entitled to 2 starter activity points to begin progressing toward the organization creation threshold.
          </p>
        </div>
      ...
      <div style={{ padding: '0.75rem', background: 'rgba(255, 255, 255, 0.03)', borderRadius: '0.5rem', marginBottom: '1rem', fontSize: '0.825rem', color: 'var(--color-text)', lineHeight: '1.5' }}>
        <p style={{ margin: '0 0 0.5rem 0' }}>
          <strong>How Welcome Points Work:</strong>
        </p>
        <ul style={{ margin: 0, paddingLeft: '1.2rem', color: 'var(--color-muted)' }}>
          <li>
            Amount is fixed at <strong>2 points</strong> (cannot be altered by user).
          </li>
          <li>
            Points are minted directly on-chain by the Protocol Admin calling <code>recordActivity(yourWallet, 2)</code> on Bohr Testnet.
          </li>
          <li>
            No native tokens or gas fees are deducted from your wallet for receiving welcome points.
          </li>
        </ul>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }}>
        {isRequested ? (
          ...
          >
            🎁 Request 2 Welcome Activity Points
          </button>
        )}
